...
out_dir = root / "artifacts" / "baseline_v1" / "B1_noop"
...
scenario_df["policy_id"] = "B1_noop"
scenario_df["policy_name"] = "no_op_baseline"
scenario_df["eval_horizon_minutes"] = 30
scenario_df["action_rule"] = "all_agents_action_zero"
...
policy_config = {
    "baseline_id": "B1_noop",
    "policy_name": "no_op_baseline",
    "definition": "all agents take action=0 for the full evaluation horizon",
