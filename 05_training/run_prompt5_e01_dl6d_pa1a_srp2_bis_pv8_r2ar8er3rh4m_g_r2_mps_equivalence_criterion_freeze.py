...
FLOAT_METRICS = [
    {
        "name": "value_t",
        "source": ("value_t",),
        "gate_dimensions": ["max_abs_diff", "mean_abs_diff", "max_rel_diff"],
    ...
    },
    {
        ...
        "gate_dimensions": ["max_abs_diff", "mean_abs_diff"],
    ...
    for spec in FLOAT_METRICS:
        ...
        criteria[name] = {
            ...
            "threshold_or_comparison_rule": {
                "rule": "MPS-equivalent iff candidate OFF↔ON metric is finite and every gated dimension is <= the frozen within-mode empirical envelope from OFF↔OFF and ON↔ON rows.",
                ...
                "max_rel_diff_policy": spec.get("relative_diff_policy", "gated"),
            },
            "evidence_rows": {
    ...
    return {
        ...
        "scientific_equivalence_rule": {
            "MPS_EQUIVALENT": [
                ...
                "OFF↔ON max_abs_diff/mean_abs_diff/max_rel_diff, except parameter max_rel report-only diagnostics, are within the frozen MPS within-mode empirical envelope",
            ...
            "MPS_NOT_EQUIVALENT": [
                ...
                "any gated float metric exceeds its frozen within-mode envelope with sufficient evidence",
...
def h4mh_preflight_release_contract(metric_criteria: Mapping[str, Any], exact_contract: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "pre_1_pass_conditions": {
            ...
            "no_instrumentation_specific_excess_variability": "Every gated OFF↔ON float metric must be <= the frozen within-mode envelope.",
            "rng_drift": 0,
