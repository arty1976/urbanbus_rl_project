-- scripts/promote_route_link_sequence.sql
-- Promote data from staging to route_link_sequence with strict validation.
...
WHERE 1=1
  ...
  AND link_id_raw IS NOT NULL             -- No null link_id
